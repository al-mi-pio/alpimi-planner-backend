        ...
        public async Task ThrowsErrorDaysOffAreOutsideOfDateRange()
        {
            ...
            Assert.Equal(
                JsonConvert.SerializeObject(
                    ...
                    {
                        new ErrorObject(
                            "There are Day Off outside of provided range. Please change them first"
                        )
                    }
                ),
                JsonConvert.SerializeObject(result.errors)
        ...
        public async Task ThrowsErrorLessonBlocksAreOutsideOfDateRange()
        {
            ...
            Assert.Equal(
                JsonConvert.SerializeObject(
                    ...
                    {
                        new ErrorObject(
                            "There are Lesson Block outside of provided range. Please change them first"
                        )
                    }
                ),
                JsonConvert.SerializeObject(result.errors)
        ...
        public async Task ThrowsErrorWhenLessonPeriodsOverlapAfterUpdatingSchoolHour()
        {
            ...
            Assert.Equal(
                JsonConvert.SerializeObject(
                    new ErrorObject[]
                    {
                        new FieldErrorObject("schoolHour", "Lesson Periods cannot overlap")
                    }
                ),
                JsonConvert.SerializeObject(result.errors)
            );
