    ...
    public class LessonBlockControllerTest : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            lessonId2 = await DbHelper.SetupLesson(
                _client,
                MockData.GetCreateSecondLessonDTODetails([subgroupId2], lessonTypeId, teacherId2)
            );
        ...
        [Fact]
        public async Task GetAllLessonBlocksReturnsLessonBlocksFromPublicSchedules()
        {
