...
namespace AlpimiTest.Entities.ELesson.Commands
{
    ...
    public class UpdateLessonCommandUnit
    {
        ...
        public async Task ThrowsErrorWhenWrongLessonTypeIdIsGiven()
        {
            ...
            var createLessonHandler = new UpdateLessonHandler(
                _dbService.Object,
                _str.Object,
                _strFields.Object
            );
        ...
        public async Task ThrowsErrorWhenNameIsAlreadyTakenByLesson()
        {
            ...
            var updateLessonHandler = new UpdateLessonHandler(
                _dbService.Object,
                _str.Object,
                _strFields.Object
            );
        ...
        public async Task ThrowsErrorWhenScheduleIdsFromLessonTypeAndSubgroupDontMatch()
        {
            var dto = MockData.GetUpdateLessonDTODetails();
            dto.SubgroupIds = [new Guid()];
            var group = MockData.GetGroupDetails();
            group.ScheduleId = Guid.NewGuid();
            _dbService
                .Setup(s => s.Get<LessonType>(It.IsAny<string>(), It.IsAny<object>()))
                .ReturnsAsync(MockData.GetLessonTypeDetails());
            _dbService
        ...
        [Fact]
        public async Task ThrowsErrorWhenScheduleIdsFromLessonTypeAndTeacherDontMatch()
        {
            var dto = MockData.GetUpdateLessonDTODetails();
            ...
            Assert.Equal(
                "Teacher must be in the same Schedule as Lesson Type",
                result.errors.First().message
            );
        }
    }
