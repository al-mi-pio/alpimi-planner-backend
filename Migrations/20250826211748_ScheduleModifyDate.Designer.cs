...
namespace alpimi_planner_backend.Migrations
{
    ...
    [Migration("20250826211748_ScheduleModifyDate")]
    partial class ScheduleModifyDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlpimiAPI.Entities.EAvailability.Availability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlpimiAPI.Entities.ECollision.Collision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CollidingObject1")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CollidingObject2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("CollisionTypeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CollisionTypeId");

                    b.ToTable("Collision");
                });

            modelBuilder.Entity("AlpimiAPI.Entities.ECollisionType.CollisionType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlpimiAPI.Entities.ECollision.Collision", b =>
                {
                    b.HasOne("AlpimiAPI.Entities.ECollisionType.CollisionType", "CollisionType")
                        .WithMany()
                        .HasForeignKey("CollisionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CollisionType");
                });
